// Generated by gencpp from file ISLH_msgs/taskInfoFromLeaderMessage.msg
// DO NOT EDIT!


#ifndef ISLH_MSGS_MESSAGE_TASKINFOFROMLEADERMESSAGE_H
#define ISLH_MSGS_MESSAGE_TASKINFOFROMLEADERMESSAGE_H
...
struct taskInfoFromLeaderMessage_
{
  typedef taskInfoFromLeaderMessage_<ContainerAllocator> Type;

  taskInfoFromLeaderMessage_()
    : sendingTime(0)
    , infoTypeID(0)
    , senderRobotID(0)
  ...
  taskInfoFromLeaderMessage_(const ContainerAllocator& _alloc)
    : sendingTime(0)
    , infoTypeID(0)
    , senderRobotID(0)
    , encounteringRobotID(0)
  ...
  typedef boost::shared_ptr< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> const> ConstPtr;

}; // struct taskInfoFromLeaderMessage_

typedef ::ISLH_msgs::taskInfoFromLeaderMessage_<std::allocator<void> > taskInfoFromLeaderMessage;

typedef boost::shared_ptr< ::ISLH_msgs::taskInfoFromLeaderMessage > taskInfoFromLeaderMessagePtr;
typedef boost::shared_ptr< ::ISLH_msgs::taskInfoFromLeaderMessage const> taskInfoFromLeaderMessageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa19d17ade63c5162ULL;
  static const uint64_t static_value2 = 0x1e68763c106dd71eULL;
};

template<class ContainerAllocator>
struct DataType< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# The task's information to the task coordinator\n\
\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ISLH_msgs::taskInfoFromLeaderMessage_<ContainerAllocator>& v)
  {
...
#endif // ISLH_MSGS_MESSAGE_TASKINFOFROMLEADERMESSAGE_H
