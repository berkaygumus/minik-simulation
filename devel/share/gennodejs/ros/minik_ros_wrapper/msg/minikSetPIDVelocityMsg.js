...
class minikSetPIDVelocityMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new minikSetPIDVelocityMsg(null);
  ...
  static datatype() {
    ...
    return 'minik_ros_wrapper/minikSetPIDVelocityMsg';
  }
  ...
  static messageDefinition() {
    ...
    return `
    # Minik Set Velocity PID Message
  ...
  static Resolve(msg) {
    ...
    const resolved = new minikSetPIDVelocityMsg(null);
...
module.exports = minikSetPIDVelocityMsg;
