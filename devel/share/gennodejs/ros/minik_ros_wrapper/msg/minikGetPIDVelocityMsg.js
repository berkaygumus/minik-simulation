...
class minikGetPIDVelocityMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new minikGetPIDVelocityMsg(null);
  ...
  static datatype() {
    ...
    return 'minik_ros_wrapper/minikGetPIDVelocityMsg';
  }
  ...
  static messageDefinition() {
    ...
    return `
    # Minik Get Velocity PID Message
  ...
  static Resolve(msg) {
    ...
    const resolved = new minikGetPIDVelocityMsg(null);
...
module.exports = minikGetPIDVelocityMsg;
